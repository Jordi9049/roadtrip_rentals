...
INSERT INTO [dbo].[PaymentType] ([PaymentID], [PaymentType])
VALUES
	(1, 'Card'),
	(2, 'Cash'),
	(3, 'Card'),
...
INSERT INTO [dbo].[Rental] ([RentalID], [CustomerID], [StartDatetime], [NoDays], [PaymentID], [PaymentDate])
VALUES
(1, 1, '2023-05-01 09:00:00', 3, 1, GETDATE()),
(2, 2, '2023-05-10 10:00:00', 5, 2, GETDATE()),
(3, 3, '2023-05-15 12:00:00', 2, 3, GETDATE());
SELECT * FROM Rental
